      ...
      <div className="custom-card p-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 items-center">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              className="w-full pl-9 pr-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-lg text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-500"
          ...
          <div>
                ...
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  {tickets.map((t) => (
                    <tr key={t.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3 px-4">
                        <div className="max-w-xs sm:max-w-sm truncate font-medium text-slate-900">
                          <Link to={`/tickets/${t.id}`} className="hover:text-brand-600">
                            {t.title}
                          </Link>
                        </div>
                      </td>
            ...
            <div className="p-4 border-t border-slate-200 bg-slate-50/50 flex items-center justify-between">
              <div className="text-xs text-slate-500">
                Showing <span className="font-semibold text-slate-800">{totalCount === 0 ? 0 : shownFrom}-{shownTo}</span> of <span className="font-semibold text-slate-800">{totalCount}</span> tickets
              </div>
