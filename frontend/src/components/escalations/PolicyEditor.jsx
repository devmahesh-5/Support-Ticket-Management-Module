    ...
    <Dialog open={open} onOpenChange={onClose} className="max-w-3xl">
      ...
      <Form form={form} onSubmit={submit} className="space-y-4">
        ...
        <Section title="Notifications">
          <p className="text-xs text-slate-600">
            SLA warnings are automatic: the <strong>assignee</strong> is notified in-app and by email at
            50%, 75% and 90% of the resolution SLA. On breach (100%) the team lead and department HOD
